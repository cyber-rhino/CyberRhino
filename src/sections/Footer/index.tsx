  ...
  return (
    <footer>
      <div className="footer-container">
        ...
        <div className="column column-expanded suport">
          <h3>Suporte</h3>
          <div className="dados">
          <div className="dado">
            <svg
        ...
        <div className="column column-expanded sections">
          <h3>Seções</h3>
          <ul>
            <li>
              <a href="#home-page">Ínicio</a>
            </li>
            <li>
              <a href="#services-page">Serviços</a>
            </li>
            <li>
              <a href="#qmsomos-page">Quem somos?</a>
            </li>
            <li>
              <a href="#contact-page">Contate-nos</a>
            </li>
          </ul>
        </div>
